...
<div id ="wad-manageMyInfo-page" class="wad-body-content">
  ...
  <div class="wad-body-content-internal-fields">
    <form action="0_action_editPatientInfo_ci.php" method="post" enctype="multipart/form-data">
      <input type="hidden" name="patient_id" value="<?=$patient_id?>">
      <label class="input-text">Country:</label><input type="text" name="country" class="input-box"  placeholder="<?php echo $patient['country']; ?>" value="<?=$patient['country']?>" pattern="[A-Za-z,. ]+" title="Can only contain characters!"><br />
      ...
      <label class="input-text">Floor Number:</label><input type="integer" name="floor_app" class="input-box-half" placeholder="<?php  echo $patient['floor_app']; ?>" value="<?=$patient['floor_app']?>" pattern="[A-Za-z0-9]{0-5}" title="Can only contain characters and integers!"></label>
      <label class="input-text">Door Number:</label><input type="integer" name="door_number" class="input-box-half"  placeholder="<?php  echo $patient['door_number']; ?>" value="<?=$patient['door_number']?>" pattern="[A-Za-z0-9]{0-5}" title="Can only contain characters and integers!"></label><br />
