...
<div id ="wad-manageMyInfo-page" class="wad-body-content">
  <div class="wad-body-content-title">Insert a New Patient</div>
  <div class="wad-body-content-internal">Information</div>
  <div class="wad-body-content-internal-fields">
    <form action="0_action_createNewPatient.php" method="post" enctype="multipart/form-data"> <!---->
      ...
      <label class="input-text">Healthcare ID:</label><input type="integer" name="healthcare_id" class="input-box" pattern="[0-9]{8}" title="Can only contain precisely 8 integers!"></label><br />
      ...
      <label class="input-text">Photo:</label>
      ...
      <label class="input-text">Door Number:</label><input type="integer" name="door_number" class="input-box-half" pattern="[A-Za-z0-9]{0-5}" title="Can only contain characters and integers!"></label><br />
